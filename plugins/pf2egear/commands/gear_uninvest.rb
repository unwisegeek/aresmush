  ...
  module Pf2egear
    class PF2GearUninvestCmd
      ...
      def handle
        ...
        # Uninvest the items that are valid.

        invest_list.each { |i| i.update(invested: false) }

        client.emit_success t('pf2egear.items_uninvested_ok', :count => invest_list.count)
      end
