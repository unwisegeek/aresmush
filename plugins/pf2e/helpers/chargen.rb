module AresMUSH
  module Pf2e
    ...
    def self.chargen_messages(ancestry, heritage, background, charclass, specialize, faith, subclass_info, to_assign=nil)
      ...
      a_rare = Global.read_config('pf2e_ancestry', ancestry)['rare'] if ancestry
      b_rare = Global.read_config('pf2e_background', background)['rare'] if background
      h_rare = Global.read_config('pf2e_heritage', heritage)['rare'] if heritage
