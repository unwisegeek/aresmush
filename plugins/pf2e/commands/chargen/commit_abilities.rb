  ...
  module Pf2e
    class PF2CommitAbilitiesCmd
      ...
      def handle
        ...
        int_mod = Pf2eAbilities.abilmod(Pf2eAbilities.getabil(enactor, "Intelligence"))
        ...
        hp_from_con = Pf2eAbilities.abilmod(Pf2eAbilities.getabil(enactor, 'Constitution')) * level
